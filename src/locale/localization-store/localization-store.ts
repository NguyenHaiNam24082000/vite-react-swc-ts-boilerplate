import { DEFAULT_LANGUAGE, supportedLngs } from '../locale/locale';
import React from 'react';
import EventEmitter from '../event-emitter/event-emitter';
import i18n from 'i18next';
import { sprintfPostprocessor, sprintf } from '../localization/localization';
...
i18n.use(initReactI18next).use(sprintfPostprocessor).use(LanguageDetector).use(HttpApi).init({
    ns: [defaultNS, 'local'],
    defaultNS,
    fallbackNS: ['local'],
    supportedLngs,
